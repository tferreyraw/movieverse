...
import "./ListaPopulares.css";
import { Pelicula } from "../pelicula/Pelicula.jsx";

export const ListaPopulares = ({ handleFavouriteClick }) => {
  const [peliculas, setPeliculas] = useState([]);

  useEffect(() => {
    get("/discover/movie?&language=es-MX&page=1").then((data) => {
      setPeliculas(
  ...
  return (
    <div className='container-fluid movieApp pb-5'>
      <h3 className='pb-2'>Peliculas populares</h3>
